...
- **Option 1: Open NCView on the host machine (recommended)**:
    - Install NCView on your host machine.
        ...
        - **Windows**: Download and build from [source](https://cirrus.ucsd.edu/~pierce/ncview_win.html) or use WSL with a Linux distribution.
...
- **Option 2: Run NCView inside the Docker container**:
